...
export class Backend implements backendInterface {
    ...
    async getTotalBillCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalBillCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalSalesAmount(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalSalesAmount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveBill(arg0: string, arg1: number, arg2: number, arg3: number, arg4: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveBill(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
